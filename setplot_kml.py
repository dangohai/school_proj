...
#--------------------------
    ...
    #-----------------------------------------
    plotdata.kml_name = "Manila Trench Earthquake"
    plotdata.kml_starttime = [2023, 1, 1, 0, 0, 0]  # Time of event in UTC
    plotdata.kml_tz_offset = 8    # Time zone offset (in hours) of event.
    ...
    plotfigure.kml_xlimits = [100,121]
    plotfigure.kml_ylimits = [5, 21]
    ...
    plotfigure.kml_xlimits = [100, 121]  # Adjusted for the region of interest
    plotfigure.kml_ylimits = [5, 21]    # Adjusted for the region of interest
    plotfigure.kml_figsize = [10.0, 10.0] 

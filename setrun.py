...
#------------------------------
 ...
 # Lower and upper edge of computational domain:
    ...
    clawdata.upper[0] = 121.0   # east longitude
    ...
    rundata.regiondata.regions.append([3, 3, 0., 10000., 100, 121, 5, 21])
    ...
    rundata.gaugedata.gauges.append([32412, 110.0, 13.0, 0., 1.e10])
...
#-------------------
    ...
    #    [topotype, fname]
    topo_path = os.path.join(scratch_dir, 'gebco_2023_n21.0_s5.0_w100.0_e121.0.asc')
    ...
    #   [topotype, fname]
    dtopo_path = os.path.join(scratch_dir, 'dtopo_manila_trench.tt3')
